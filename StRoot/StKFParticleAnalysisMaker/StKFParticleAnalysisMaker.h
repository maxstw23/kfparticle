...
private:
	...
	TH1D *hLambdaM_pt[num_pt_bin][9]; // lambda inv mass in different pT and centralities
	TH1D *hLambdabarM_pt[num_pt_bin][9]; // lambdabar inv mass in different pT and centralities
	TProfile *hLambda_EPD_v2_pt[num_pt_bin][9]; // lambda v2 vs. pT in different centralities
	TProfile *hLambda_TPC_v2_pt[num_pt_bin][9];
	TProfile *hLambdabar_EPD_v2_pt[num_pt_bin][9];
	TProfile *hLambdabar_TPC_v2_pt[num_pt_bin][9];
